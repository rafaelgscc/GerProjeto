<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="Lista_das_Diretorias.aspx.cs" Inherits="PROJETO.DataPages.Lista_das_Diretorias" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Lista_das_Diretorias.css" OrderIndex="2"/>
		</StyleSheets>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/Lista_das_Diretorias_USER.js?sv=v1.0.11_20221207155646"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Pages/CadastroDiretorias.aspx?Param_Codigo_Dir={Param_Codigo_Dir}") %>';
			UrlPage = UrlPage.replace('{Param_Codigo_Dir}', '');
		...
		function ___WSDiretoria_OnClientPageLoad(sender, args)
		{
			OnClientPageLoad(sender);
		}
		function ___WSDiretoria_OnClientShow(sender, args)
		{
			OnClientShow(sender);
		}
		function ___WSDiretoria_OnClientClose(sender, args)
		{
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<telerik:RadWindowManager id="WSDiretoria" runat="server" AutoSize="True" Behaviors="Default" CssClass="c_WSDiretoria" DestroyOnClose="True"
						EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False" OnClientClose="___WSDiretoria_OnClientClose"
						OnClientPageLoad="___WSDiretoria_OnClientPageLoad" OnClientShow="___WSDiretoria_OnClientShow" PreserveClientState="True" RenderMode="Classic"
							...
							<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="codigo" EditMode="InPlace">
								<Columns>
									...
									<telerik:GridBoundColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
										ConvertEmptyStringToNull="False" DataField="nomeDiretoria" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="258"
										FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn3" HeaderStyle-Width="293"
										HeaderText="<%$ Resources: GridColumn3 %>" ItemStyle-CssClass="c_GridColumn3" ItemStyle-Width="286" MaxLength="100" ReadOnly="False"
										ShowFilterIcon="True" ShowSortIcon="True" />
									<telerik:GridBoundColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
										ConvertEmptyStringToNull="False" DataField="nomeDiretor" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="158"
										FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn4" HeaderStyle-Width="193"
										HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-CssClass="c_GridColumn4" ItemStyle-Width="186" MaxLength="100" ReadOnly="False"
										ShowFilterIcon="True" ShowSortIcon="True" />
									<telerik:GridButtonColumn UniqueName="GridColumn5" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
										...
										ItemStyle-Width="86" ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn5_1 %>" />
