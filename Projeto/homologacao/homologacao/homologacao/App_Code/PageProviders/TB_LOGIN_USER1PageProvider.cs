...
namespace PROJETO.DataProviders
{
	...
	public class TB_LOGIN_USER1PageProvider : GeneralProvider
	{
		...
		public TB_LOGIN_USER1PageProvider(IGeneralDataProvider Provider)
		{
			...
			MainProvider.DataProvider = new DBGERPROJETO_TB_LOGIN_USERDataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "LOGIN_USER_PK", "TB_LOGIN_USER1");
			MainProvider.DataProvider.PageProvider = this;
			ComboBox2Provider = new DBGERPROJETO_TB_LOGIN_GROUPDataProvider(MainProvider, "TB_LOGIN_GROUP", "DBGERPROJETO", "", "TB_LOGIN_USER1_ComboBox2ProviderAlias");
			ComboBox2Provider.PageProvider = this;
			ComboBox2Provider.CreatingParameters += GeneralDataProvider.GeneralCreatingParameters;
			ComboBox3Provider = new DBGERPROJETO_TB_COORDENACAODataProvider(MainProvider, "TB_COORDENACAO", "DBGERPROJETO", "", "TB_LOGIN_USER1_ComboBox3ProviderAlias");
