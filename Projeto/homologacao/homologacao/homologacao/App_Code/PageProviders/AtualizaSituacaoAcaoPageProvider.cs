...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class AtualizaSituacaoAcaoProcessProvider : GeneralProvider
	{
		public TabelaAcoesProcessProvider TabelaAcoesPreDefProvider;

		public AtualizaSituacaoAcaoProcessProvider(IGeneralDataProvider Provider)
		{
			MainProvider = Provider;
			TabelaAcoesPreDefProvider = new TabelaAcoesProcessProvider(MainProvider, "TB_ITENS_PROJETO", "DBGERPROJETO");
		}
		...
		public void ExecutePreDefinedProcess()
		{
			...
			try
			{
				...
				TabelaAcoesPreDefProvider.ExecutePreDefinedProcess(null, AliasVariables, allDaos);
