        ...
        if (Panel != null)
        {
            ...
            if (Count >= ButtonsCount)
            {
                for (int i = 0; i < ButtonsCount; i++)
                {
                    ...
                    {
                        ((Button)Panel.FindControl("__" + Panel.ID + "__Button" + BtnPosCounter.ToString())).CssClass = Panel.ID + "_SelectedButton";
                    }
                    else
                    {
                        ((Button)Panel.FindControl("__" + Panel.ID + "__Button" + BtnPosCounter.ToString())).CssClass = "";
                    }
                    BtnPosCounter++;
                    startNum++;
                }
