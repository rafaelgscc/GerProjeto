...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class TB_PROJETO2PageProvider : GeneralProvider
	{
		public Home_Grid2GridDataProvider Home_Grid2Provider;
		public DBGERPROJETO_TB_LOGIN_USERDataProvider AUX_TB_PROJETO2_TB_LOGIN_USERProvider;
		public DBGERPROJETO_TB_COORDENACAODataProvider cmbCoordenacaoProvider;

		public TB_PROJETO2PageProvider(IGeneralDataProvider Provider)
		{
			MainProvider = Provider;
			MainProvider.DataProvider = new DBGERPROJETO_TB_PROJETODataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "PK_TB_PROJETO", "TB_PROJETO2");
			MainProvider.DataProvider.PageProvider = this;
			AUX_TB_PROJETO2_TB_LOGIN_USERProvider = new DBGERPROJETO_TB_LOGIN_USERDataProvider(MainProvider, "TB_LOGIN_USER", "DBGERPROJETO", "", "AUX_TB_PROJETO2_TB_LOGIN_USER");
			cmbCoordenacaoProvider = new DBGERPROJETO_TB_COORDENACAODataProvider(MainProvider, "TB_COORDENACAO", "DBGERPROJETO", "", "TB_PROJETO2_cmbCoordenacaoProviderAlias");
			cmbCoordenacaoProvider.PageProvider = this;
			cmbCoordenacaoProvider.CreatingParameters += GeneralDataProvider.GeneralCreatingParameters;
			Home_Grid2Provider = new Home_Grid2GridDataProvider(this);
			Home_Grid2Provider.SetRelationFields += new GeneralGridProvider.SetRelationFieldsEventHandler(Home_Grid2Provider_SetRelationFields);
		}


		private void Home_Grid2Provider_SetRelationFields(object sender, GeneralDataProviderItem Item)
		{
			try
			{
				...
				Home_Grid2Provider.AliasVariables = new Dictionary<string, object>();
			}
			catch (Exception)
			{
			}
		...
		public override GeneralDataProviderItem GetDataProviderItem(GeneralDataProvider Provider)
		{
			...
			else if (Provider.Name == "AUX_TB_PROJETO2_TB_LOGIN_USER")
			{
			...
			if (Provider == cmbCoordenacaoProvider)
			{
		...
		{
			MainProvider.SetParametersValues(AUX_TB_PROJETO2_TB_LOGIN_USERProvider);
			AUX_TB_PROJETO2_TB_LOGIN_USERProvider.Dao = MainProvider.DataProvider.Dao;
			AUX_TB_PROJETO2_TB_LOGIN_USERProvider.SelectItem(1, FormPositioningEnum.First,false);
		}
		...
		public override GeneralDataProviderItem GetComboItem(GeneralDataProvider Provider, string Value)
		{
			try
			{
				...
				if (Provider == cmbCoordenacaoProvider && !string.IsNullOrEmpty(Value))
				{
	...
	/// </summary>
	public class Home_Grid2GridDataProvider : GeneralGridProvider
	{
		...
		public TB_PROJETO2PageProvider ParentPageProvider;
		...
		public Home_Grid2GridDataProvider(TB_PROJETO2PageProvider ParentProvider)
		{
			ParentPageProvider = ParentProvider;
			DataProvider = new DBGERPROJETO_TB_PROJETODataProvider(this, TableName, DatabaseName, "PK_TB_PROJETO", "Home_Grid2");
			MainProvider = this;
			MainProvider.DataProvider.PageProvider = this;
		}
		...
		{
		ParentPageProvider = (TB_PROJETO2PageProvider)ParentProvider;
		}
