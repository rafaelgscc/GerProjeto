...
{
	public partial class DBGERPROJETO_TB_SETORIALItem : GeneralDataProviderItem
	{
		...
		public DBGERPROJETO_TB_SETORIALItem(string DataBaseName) : this(DataBaseName, true)
		{
		}

		public DBGERPROJETO_TB_SETORIALItem(string DataBaseName, params string[] FieldNames) : this(DataBaseName, false, FieldNames)
		{
		}
		...
		/// </summary>
		private DBGERPROJETO_TB_SETORIALItem(string DataBaseName, bool AllFields, params string[] FieldNames)
		{
		...
		public static Dictionary<string, FieldBase> CreateItemFields(bool AllFields, params string[] FieldNames)
		{
			...
			if (AllFields || Contains(FieldNames, "nomeSetorial")) NewFields.Add("nomeSetorial", new TextField("nomeSetorial", "", null, true));
	...
	/// </summary>
	public class DBGERPROJETO_TB_SETORIALDataProvider : GeneralDataProvider
	{
		...
		{
			return DBGERPROJETO_TB_SETORIALItem.CreateItemFields(true); 
		}
	
		public DBGERPROJETO_TB_SETORIALDataProvider(IGeneralDataProvider BasePage, string TableName, string DataBaseName, string IndexName, string Name) : base(BasePage, TableName, DataBaseName, IndexName, Name, "", false)
		{
		}
		...
		{
			return this.GetFilterExpression( DBGERPROJETO_TB_SETORIALItem.CreateItemFields(false, GetUniqueKeyFields()));
		}
