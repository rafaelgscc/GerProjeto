...
{
	public partial class DBGERPROJETO_TB_LOGIN_GROUPItem : GeneralDataProviderItem
	{
		...
		public DBGERPROJETO_TB_LOGIN_GROUPItem(string DataBaseName) : this(DataBaseName, true)
		{
		}

		public DBGERPROJETO_TB_LOGIN_GROUPItem(string DataBaseName, params string[] FieldNames) : this(DataBaseName, false, FieldNames)
		{
		}
		...
		/// </summary>
		private DBGERPROJETO_TB_LOGIN_GROUPItem(string DataBaseName, bool AllFields, params string[] FieldNames)
		{
	...
	/// </summary>
	public class DBGERPROJETO_TB_LOGIN_GROUPDataProvider : GeneralDataProvider
	{
		...
		{
			return DBGERPROJETO_TB_LOGIN_GROUPItem.CreateItemFields(true); 
		}
	
		public DBGERPROJETO_TB_LOGIN_GROUPDataProvider(IGeneralDataProvider BasePage, string TableName, string DataBaseName, string IndexName, string Name) : base(BasePage, TableName, DataBaseName, IndexName, Name, "", false)
		{
		}
		...
		{
			return this.GetFilterExpression( DBGERPROJETO_TB_LOGIN_GROUPItem.CreateItemFields(false, GetUniqueKeyFields()));
		}
