...
{
	public partial class DBGERPROJETO_TBV_STATUS_ACAOItem : GeneralDataProviderItem
	{
		...
		public DBGERPROJETO_TBV_STATUS_ACAOItem(string DataBaseName) : this(DataBaseName, true)
		{
		}

		public DBGERPROJETO_TBV_STATUS_ACAOItem(string DataBaseName, params string[] FieldNames) : this(DataBaseName, false, FieldNames)
		{
		}
		...
		/// </summary>
		private DBGERPROJETO_TBV_STATUS_ACAOItem(string DataBaseName, bool AllFields, params string[] FieldNames)
		{
		...
		public static Dictionary<string, FieldBase> CreateItemFields(bool AllFields, params string[] FieldNames)
		{
			...
			if (AllFields || Contains(FieldNames, "acao")) NewFields.Add("acao", new TextField("acao", "", null, true));
	...
	/// </summary>
	public class DBGERPROJETO_TBV_STATUS_ACAODataProvider : GeneralDataProvider
	{
		...
		{
			return DBGERPROJETO_TBV_STATUS_ACAOItem.CreateItemFields(true); 
		}
	
		public DBGERPROJETO_TBV_STATUS_ACAODataProvider(IGeneralDataProvider BasePage, string TableName, string DataBaseName, string IndexName, string Name) : base(BasePage, TableName, DataBaseName, IndexName, Name, "", true)
		{
		}
		...
		{
			return this.GetFilterExpression( DBGERPROJETO_TBV_STATUS_ACAOItem.CreateItemFields(false, GetUniqueKeyFields()));
		}
