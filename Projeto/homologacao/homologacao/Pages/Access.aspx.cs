...
namespace PROJETO
{
	...
	public partial class Access : System.Web.UI.Page
	{
		...
		public string ProjectID { get { return "328917AC"; } }
			...
			try
			{
				...
				{		
					...
					try
					{
						...
						FillGroupsListBox();
						FillUserListBox();
						ListBox3.SelectedValue = ListBox3.FindItemByText(TextBox6.Text).Value;
						ListBox5.SelectedValue = ListBox3.SelectedValue;
						ViewState["Insert"] = false;
						EnableGroupButtons(true, true, true, true);
						ListBox3.Enabled = true;
					}
		...
		private void DeleteUser()
		{
			try
			{
				if (CurrentGroup != null && (bool)CurrentGroup.Fields["IsAdmin"].Value)
				{		
					if (ListBox6.SelectedItem.Text == Crypt.Decripta(HttpContext.Current.Session["vgUserLogin"].ToString()))
					{
