...
{
	var currentPath = window.document.URL;
	var path64 = "";

	if (currentPath !== null) {
		path64 = btoa(currentPath);
	} else {

		var fullPath = AppPath + "Pages/" + document.getElementById("__PAGENAME").value;
		path64 = btoa(fullPath);
	}

	var Path = AppPath + "Pages/Filtro.aspx?TableName=" + document.getElementById("__TABLENAME").value + "&DatabaseName=" + document.getElementById("__DATABASENAME").value + "&PageName=" + document.getElementById("__PAGENAME").value + "&cp=" + path64;
