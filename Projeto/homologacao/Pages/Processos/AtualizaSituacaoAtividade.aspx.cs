...
namespace PROJETO.DataPages
{
	...
	public partial class AtualizaSituacaoAtividade : GeneralDataProcess
	{

		private AtualizaSituacaoAtividadeProcessProvider PageProvider;

		public override string FormID { get { return "32790"; } }
		public override string PageName { get { return "AtualizaSituacaoAtividade.aspx"; } }

		public override void CreateProvider()
		{
			PageProvider = new AtualizaSituacaoAtividadeProcessProvider(this);
		}
...
#region CÓDIGO DE USUARIO
		...
		protected void Form1_OnLoad()
		{
            ...
            DataTable DT = Dao.RunSql(String.Format("UPDATE TB_PROCESSOS SET TB_PROCESSOS.situacao = CASE WHEN (percentualExecutado = 100) THEN 'CONCLUÍDO' WHEN (inicioRealizado IS NULL AND terminoRealizado is null) THEN 'A INICIAR' WHEN (inicioRealizado is not null and terminoRealizado is null and percentualExecutado < 100 and GETDATE() > terminoPrevisto) THEN 'ATRASADO' WHEN (inicioRealizado is not null and terminoRealizado is null and percentualExecutado < 100 and GETDATE()-15 < terminoPrevisto) THEN 'EM DIA' END")).Tables[0];
