...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class Coordenacao_GeralPageProvider : GeneralProvider
	{
		public Lista_das_Coordenacoes_Grid1GridDataProvider Lista_das_Coordenacoes_Grid1Provider;

		public Coordenacao_GeralPageProvider(IGeneralDataProvider Provider)
		{
			MainProvider = Provider;
			MainProvider.DataProvider = new DBGERPROJETO_TB_PARAMETRODataProvider(MainProvider, MainProvider.TableName, MainProvider.DatabaseName, "", "Coordenacao_Geral");
			MainProvider.DataProvider.PageProvider = this;
			Lista_das_Coordenacoes_Grid1Provider = new Lista_das_Coordenacoes_Grid1GridDataProvider(this);
			Lista_das_Coordenacoes_Grid1Provider.SetRelationFields += new GeneralGridProvider.SetRelationFieldsEventHandler(Lista_das_Coordenacoes_Grid1Provider_SetRelationFields);
		}


		private void Lista_das_Coordenacoes_Grid1Provider_SetRelationFields(object sender, GeneralDataProviderItem Item)
		{
			try
			{
				...
				Lista_das_Coordenacoes_Grid1Provider.AliasVariables = new Dictionary<string, object>();
			}
			catch (Exception)
			{
			}
	...
	/// </summary>
	public class Lista_das_Coordenacoes_Grid1GridDataProvider : GeneralGridProvider
	{
		...
		private DBGERPROJETO_TB_COORDENACAODataProvider _DataProvider;
		...
		public override GeneralDataProvider DataProvider
		{
			...
			set
			{
				_DataProvider = value as DBGERPROJETO_TB_COORDENACAODataProvider;
			}
		}

		public Coordenacao_GeralPageProvider ParentPageProvider;
		
		public override string TableName { get { return "TB_COORDENACAO"; } }

		public override string DatabaseName { get { return "DBGERPROJETO"; } }

		public override string FormID { get { return "32726"; } }
		...
		public Lista_das_Coordenacoes_Grid1GridDataProvider(Coordenacao_GeralPageProvider ParentProvider)
		{
			ParentPageProvider = ParentProvider;
			DataProvider = new DBGERPROJETO_TB_COORDENACAODataProvider(this, TableName, DatabaseName, "PK_TB_COORDENACAO", "Lista_das_Coordenacoes_Grid1");
			MainProvider = this;
			MainProvider.DataProvider.PageProvider = this;
		}
		public DBGERPROJETO_TB_COORDENACAOItem GetDataProviderItem()
		{
			return GetDataProviderItem(MainProvider.DataProvider) as DBGERPROJETO_TB_COORDENACAOItem;
		}

		public override GeneralDataProviderItem GetDataProviderItem(GeneralDataProvider Provider)
		{
			if (Provider.Name == "Lista_das_Coordenacoes_Grid1")
			{
				return new DBGERPROJETO_TB_COORDENACAOItem(DatabaseName);
			}
			return null;
		}
		...
		{
		ParentPageProvider = (Coordenacao_GeralPageProvider)ParentProvider;
		}
		...
		public override void InitializeAlias(GeneralDataProviderItem Item)
		{
			...
			nomeCoordenacaoField = Convert.ToString(Item["nomeCoordenacao"].GetValue(),CultureInfo.CurrentCulture);
			if (AliasVariables.ContainsKey("nomeCoordenacaoField"))
			{
				AliasVariables["nomeCoordenacaoField"] = nomeCoordenacaoField;
			}
			else
			{
				AliasVariables.Add("nomeCoordenacaoField" ,nomeCoordenacaoField);
			}
			nomeCoordenadorField = Convert.ToString(Item["nomeCoordenador"].GetValue(),CultureInfo.CurrentCulture);
			if (AliasVariables.ContainsKey("nomeCoordenadorField"))
			{
				AliasVariables["nomeCoordenadorField"] = nomeCoordenadorField;
			}
			else
			{
				AliasVariables.Add("nomeCoordenadorField" ,nomeCoordenadorField);
			}
