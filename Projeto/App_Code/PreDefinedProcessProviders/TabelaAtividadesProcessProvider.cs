...
namespace PROJETO.DataProviders
{
	...
	/// </summary>
	public class TabelaAtividadesProcessProvider: GeneralProvider
	{
		public DBGERPROJETO_TB_PROCESSOSDataProvider DataProvider;
		
		public TabelaAtividadesProcessProvider(IGeneralDataProvider Provider, string TableName, string DataBaseName)
		{
			MainProvider = Provider;
			DataProvider = new DBGERPROJETO_TB_PROCESSOSDataProvider(MainProvider, TableName, DataBaseName, "PK_TB_PROCESSOS", "AtualizaSituacaoAtividades");
