...
public static class EmailRecuperacaoSenhaSendEmail
{
	public static bool Send(string ParNAME, string ParLOGIN, string ParEMAIL, string ParPASSWORD)
	{
		EmailRecuperacaoSenhaEmailProvider Email = new EmailRecuperacaoSenhaEmailProvider((ParNAME), (ParLOGIN), (ParEMAIL), (ParPASSWORD));
		return Email.Send();
	}
}

public class EmailRecuperacaoSenhaEmailProvider
{
	public string ParNAME = "";
	public string ParLOGIN = "";
	public string ParEMAIL = "";
	public string ParPASSWORD = "";
	public EmailRecuperacaoSenhaEmailProvider(string ParNAME, string ParLOGIN, string ParEMAIL, string ParPASSWORD)
	{
	...
	public string Assunto
	{
		get
		{
			return ("Recuperação de Senha: GProjeto").ToString();
		}
	}
	...
	public string Conteudo
	{
		get
		{
			string EMail = System.IO.File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory.TrimEnd('\\') + @"\Pages\Email\EmailRecuperacaoSenhaEmailBody.gwmail");
			EMail = EMail.Replace("¥", "");
			return EMail;
		}
	}
