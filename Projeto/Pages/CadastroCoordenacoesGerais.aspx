<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="CadastroCoordenacoesGerais.aspx.cs" Inherits="PROJETO.DataPages.CadastroCoordenacoesGerais" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/CadastroCoordenacoesGerais.css" OrderIndex="2"/>
		</StyleSheets>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/CadastroCoordenacoesGerais_USER.js?sv=v1.0.11_20221213104559"></script>
	...
	<script type="text/javascript">
		...
		{
			ExecuteCommandRequest("Save","","","continue:___Button3_OnClientClick_Action1");
			args.set_cancel(true);
			return false;
		}
		function ___Button3_OnClientClick_Action1(sender, args)
		{
			try { GetRadWindow().Caller.Refresh();} catch (e) {};
			args.set_cancel(true);
			return false;
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="Div1" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10" class="c_Div1">
						<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Cadastro de Coordenações" />
						<telerik:RadButton id="Button4" runat="server" ButtonType="SkinnedButton" CssClass="c_Button4" CommandName="Button4"
							OnClientClicking="___Button4_OnClientClick" RenderMode="Lightweight" TabIndex="10" Text="<%$ Resources: Button4 %>">
						</telerik:RadButton>
						<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton" CssClass="c_Button1" CommandName="Button1"
							OnClientClicking="___Button1_OnClientClick" RenderMode="Lightweight" TabIndex="9" Text="<%$ Resources: Button1 %>">
						</telerik:RadButton>
					...
					<div id="Div2" runat="server" AutoExpandToContent="False" AutoExpandToContentMargin="10" class="c_Div2">
						<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" CssClass="c_RadTextBox3"
							data-validation-engine="validate[funcCall[RadTextBox3_Validation]]" data-validation-message="Sigla da Coordenacao não pode ser vazio!"
						...
						<telerik:RadTextBox id="RadTextBox4" runat="server" AutoPostBack="False" CssClass="c_RadTextBox4"
							data-validation-engine="validate[funcCall[RadTextBox4_Validation]]" data-validation-message="Nome da Coordenacao não pode ser vazio!"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function siglaCoordenacao() { return document.getElementById('RadTextBox3').value; }
		function nomeCoordenacao() { return document.getElementById('RadTextBox4').value; }
		function siglaDiretoria() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function nomeCoordenador() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
